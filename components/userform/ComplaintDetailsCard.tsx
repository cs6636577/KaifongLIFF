        ...
        <div className=" rounded-xl  bg-white p-3 shadow-sm">
            ...
            <div className="m-3">
                <div className="relative bg-[#4D4632]/7 rounded-full px-4 py-3 block overflow-hidden">
                    ...
                    <div className="flex items-center gap-1 mb-1">
                        <p className="text-[11px] font-semibold text-[#4D4632]/60">
                            หัวข้อปัญหา
                        </p>

                        <p className="text-[9px] text-[#4D4632]/50">
                            Problem Category
                        </p>
                    </div>

                    <p className="text-lg font-bold text-[#2F2A1F]">
                        ถนนชำรุด
                    </p>
            ...
            <div className="m-3">
                ...
                <div className="flex gap-2">
                    ...
                    <span className="text-md text-[#1A1A2E] font-semibold">{"ถนนสุขุมวิท"}</span>
                </div>
            </div>
            ...
            <div className="m-3">
                ...
                <p className="text-md text-[#1A1A2E] ">{'ถนนหน้าหมู่บ้านมีหลุมขนาดใหญ่ รถผ่านลำบากและเป็นอันตราย'}</p>
            </div>
